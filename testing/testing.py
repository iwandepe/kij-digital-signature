...
def load():
    ...
    # PEM encoded
    with open(RELATIVE_PATH + 'static/private_key.pem', 'wb') as pk:
    ...
    with open(RELATIVE_PATH + 'static/certificate.cer', 'wb') as cer:
...
def sign_file(input_file: str, signatureID: str, x_coordinate: int, 
    ...
    # Signature image
    sign_filename = RELATIVE_PATH + "static/signature.png"
    # Self signed certificate
    pk_filename = RELATIVE_PATH + "static/container.pfx"
